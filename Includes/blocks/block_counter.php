...
function affich_block_counter($blok){
    ...
    $visites = str_replace('0', '<img src="modules/Stats/images/compteur/0.png" alt="" />', $visites);
    $visites = str_replace('1', '<img src="modules/Stats/images/compteur/1.png" alt="" />', $visites);
    $visites = str_replace('2', '<img src="modules/Stats/images/compteur/2.png" alt="" />', $visites);
    $visites = str_replace('3', '<img src="modules/Stats/images/compteur/3.png" alt="" />', $visites);
    $visites = str_replace('4', '<img src="modules/Stats/images/compteur/4.png" alt="" />', $visites);
    $visites = str_replace('5', '<img src="modules/Stats/images/compteur/5.png" alt="" />', $visites);
    $visites = str_replace('6', '<img src="modules/Stats/images/compteur/6.png" alt="" />', $visites);
    $visites = str_replace('7', '<img src="modules/Stats/images/compteur/7.png" alt="" />', $visites);
    $visites = str_replace('8', '<img src="modules/Stats/images/compteur/8.png" alt="" />', $visites);
    $visites = str_replace('9', '<img src="modules/Stats/images/compteur/9.png" alt="" />', $visites);

    $blok['content'] = '<div id="blockcounter">' . $visites . '</div>';
