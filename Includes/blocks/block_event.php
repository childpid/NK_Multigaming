...
function affich_block_event($blok){
    ...
    $blok['content'] .= '<table class="table-condensed table-bordered table-striped center"><tr><td colspan="7"><div class="btn-group">'
					 . '<a href="index.php?file='.$file.'&amp;mo=' . $prevmonth . '&amp;ye='.$prevyear.'" title="'._PREVMONTH.'" class="btn"><i class="icon-chevron-left"></i>'
					 . '</a><a class="btn">'.$months[$this_month].'&nbsp;'.$year.'</a>'
					 . '<a href="index.php?file='.$file.'&amp;mo='.$nextmonth.'&amp;ye='.$nextyear.'" title="'._NEXTMONTH.'" class="btn"><i class="icon-chevron-right"></i></a></div></td></tr>'
					 . '<tr>';
