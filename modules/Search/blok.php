...
if ($active == 3 || $active == 4){
	...
	echo '<div id="blocksearch"><form class="form-search center" method="post" action="index.php?file=Search&amp;op=mod_search"><div class="input-append">'
	. '<input type="hidden" name="module" value="" />'
	. '<input type="text" name="main "class="span8 search-query">'
    . '<button type="submit" class="btn">' . _SEARCHFOR . '</button>'
	. '</div></form>'
	. '<p style="text-align:center"><a class="btn btn-primary" href="index.php?file=Search">' . _ADVANCEDSEARCH . '</a></p></div>';
}
?>